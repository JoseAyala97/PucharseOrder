    ...
    public partial class FirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Calle 10 # 20-30", "900123456", "Acme S.A." },
                    { 2, "Av. 26 # 85-12", "800987654", "Globant" },
                    { 3, "Calle 34 #", "10191000", "SkillNet" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "P-001", "Teclado", 120.00m },
                    { 2, "P-002", "Mouse", 60.00m },
                    { 3, "P-003", "Monitor 24", 950.00m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pedido Creado", "Registrado" },
                    { 2, "Pedido Confirmado", "Confirmado" },
                    { 3, "Pedido Anulado", "Anulado" }
                });
